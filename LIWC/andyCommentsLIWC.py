...
c.execute("SELECT C.userID, CG.username, C.commentBody  FROM commenterGender CG,comments C where C.userID = CG.userID and C.username = CG.username and gender = 'andy'")

words_count = 0
comments_count = 0
file_count = 0
filename = "andy_comments_"+str(file_count)+".txt"
...
print "Avg word_count per Andy_Comment :"+str(words_count/comments_count)
